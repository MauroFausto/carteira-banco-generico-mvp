...
import images from "../../../img/flags/*.svg";
...
export const geographicalEngagementas = () => {
	...
	const markerFils = {
		1: rgba("--bs-highlight-rgb", 1),
		2: rgba("--bs-highlight-rgb", 0.8),
		3: rgba("--bs-highlight-rgb", 0.6),
		4: rgba("--bs-highlight-rgb", 0.4),
		5: rgba("--bs-highlight-rgb", 0.2),
	};
	...
	if (MAP_WRAPPER) {
		...
		new jsVectorMap({
			...
			regionStyle: {
				initial: {
					fill: rgba("--bs-highlight-rgb", 0.2),
					fillOpacity: 1,
		...
		DATA.forEach((item, index) => {
			list += `<div class="d-flex align-items-start">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 ${index !== last ? "border-bottom mb-2 pb-2" : ""}">
                            ...
                            <div class="badge rounded-pill fs-8 ms-auto text-body-emphasis d-inline-flex align-items-center mt-n1 bg-opacity-75 ${item.up ? "bg-success" : "bg-danger"}">
