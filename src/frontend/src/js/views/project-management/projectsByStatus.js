		...
		datasets: [
			{
				...
				backgroundColor: (context) => [
					chartGradient(context, "rgba(30, 145, 255, 0.25)", "rgba(30, 145, 255, 0"),
					chartGradient(context, "rgba(40, 199, 111, 0.25)", "rgba(40, 199, 111, 0"),
					chartGradient(context, "rgba(254, 168, 76, 0.25)", "rgba(254, 168, 76, 0"),
					chartGradient(context, "rgba(38, 198, 218, 0.25)", "rgba(38, 198, 218, 0"),
					chartGradient(context, "rgba(255, 99, 99, 0.25)", "rgba(255, 99, 99, 0"),
					chartGradient(context, "rgba(226, 108, 245, 0.25)", "rgba(226, 108, 245, 0"),
				],
				borderColor: (context) => [
					chartGradient(context, "rgba(30, 145, 255, 0.9)", "rgba(30, 145, 255, 1"),
					chartGradient(context, "rgba(40, 199, 111, 0.9)", "rgba(40, 199, 111, 0.75"),
					chartGradient(context, "rgba(254, 168, 76, 0.9)", "rgba(254, 168, 76, 0.75"),
					chartGradient(context, "rgba(38, 198, 218, 0.9)", "rgba(38, 198, 218, 0.75"),
					chartGradient(context, "rgba(255, 99, 99, 0.9)", "rgba(255, 99, 99, 0.75"),
					chartGradient(context, "rgba(226, 108, 245, 0.9)", "rgba(226, 108, 245, 0.75"),
				],
				borderRadius: 5,
				borderWidth: 1.25,
			},
		...
		DATA.forEach((item, index) => {
			list += `<div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 d-flex align-items-center py-3 ${index !== DATA.length - 1 ? "border-bottom" : ""}">
							...
							<span class="badge rounded-pill fs-8 ms-auto text-body-emphasis d-inline-flex align-items-center mt-n1 ${item.up ? "bg-success" : "bg-danger"}">
								${item.change}
