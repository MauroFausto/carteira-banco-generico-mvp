	...
	if (WRAPPER) {
		...
		DATA.map((item, index) => {
			list += `<a href="" class="d-block text-white">
                        <div class="bg-hover rounded text-center p-3">
                            <i class="ph ph-${item.icon} fs-3 h-12 w-12 d-inline-flex align-items-center justify-content-center rounded-circle bg-active"></i>
