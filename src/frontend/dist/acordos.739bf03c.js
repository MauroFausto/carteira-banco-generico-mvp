...
var _userSwitcher = require("./layout/header/userSwitcher");
var _dashboard = require("./views/banco/dashboard");
var _solicitacoes = require("./views/banco/solicitacoes");
var _contratos = require("./views/banco/contratos");
var _saldoDevedor = require("./views/banco/saldoDevedor");
var _acordos = require("./views/banco/acordos");
// Banco views
(0, _dashboard.dashboardBanco)();
(0, _solicitacoes.solicitacoesBanco)();
(0, _contratos.contratosBanco)();
(0, _saldoDevedor.saldoDevedorBanco)();
(0, _acordos.acordosBanco)();
(0, _userSwitcher.userSwitcher)();

},{"../scss/style.scss":"fZrcq","./layout/header/userSwitcher":"1PeYt","./views/banco/dashboard":"enPj8","./views/banco/solicitacoes":"1Wn5u","./views/banco/contratos":"4sSri","./views/banco/saldoDevedor":"1NQnr","./views/banco/acordos":"7gJdN"}],"fZrcq":[function() {},{}],"1PeYt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "userSwitcher", ()=>userSwitcher);
var _client = require("../../api/client");
const userSwitcher = ()=>{
    const select = document.getElementById("cb-user-switcher");
    if (!select) return;
    const { userId, userRole } = (0, _client.getAuthContext)();
    const currentValue = `${userId}|${userRole}`;
    const hasCurrentOption = Array.from(select.options).some((option)=>option.value === currentValue);
    if (hasCurrentOption) select.value = currentValue;
    select.addEventListener("change", ()=>{
        const [nextUserId, nextRole] = select.value.split("|");
        (0, _client.setAuthContext)({
            userId: nextUserId,
            userRole: nextRole
        });
...
},{"../../api/client":"1HkaN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HkaN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAuthContext", ()=>getAuthContext);
parcelHelpers.export(exports, "setAuthContext", ()=>setAuthContext);
parcelHelpers.export(exports, "clearAuthContext", ()=>clearAuthContext);
parcelHelpers.export(exports, "setApiBaseUrl", ()=>setApiBaseUrl);
parcelHelpers.export(exports, "apiGet", ()=>apiGet);
parcelHelpers.export(exports, "apiPost", ()=>apiPost);
parcelHelpers.export(exports, "apiGetBlob", ()=>apiGetBlob);
parcelHelpers.export(exports, "apiPostNoBody", ()=>apiPostNoBody);
const STORAGE_KEYS = {
    userId: "cb-user-id",
...
const setAuthContext = ({ userId, userRole })=>{
    if (userId) localStorage.setItem(STORAGE_KEYS.userId, userId);
    if (userRole) localStorage.setItem(STORAGE_KEYS.userRole, userRole);
};
...
const apiGetBlob = async (path, options = {})=>{
    const response = await request(path, {
        ...options,
        method: "GET"
    });
...
const apiPostNoBody = async (path, options = {})=>{
    const response = await request(path, {
        ...options,
        method: "POST"
    });
...
},{}],"enPj8":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dashboardBanco", ()=>dashboardBanco);
...
const statusDataset = (solicitacoes)=>{
    const statusMap = solicitacoes.reduce((acc, item)=>{
...
const renderChart = (canvas, solicitacoes)=>{
    ...
    dashboardChart = new (0, _autoDefault.default)(canvas, {
        type: "doughnut",
        data: {
            labels: data.labels,
            datasets: [
...
const dashboardBanco = async ()=>{
    ...
    try {
        const [cliente, health, solicitacoes, contratos] = await Promise.all([
            (0, _endpoints.getClienteLogado)(),
            (0, _endpoints.healthCheck)(),
            (0, _endpoints.listarSolicitacoes)(),
            (0, _endpoints.listarContratos)()
        ]);
        ...
        fillText("cb-dashboard-saldo-total", (0, _helpers.formatCurrency)(saldoEstimado));
        renderChart(canvas, solicitacoes);
    } catch (error) {
        (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
    }
};

},{"chart.js/auto":"d8NN9","../../api/endpoints":"8r3Mu","./helpers":"1O6lp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8r3Mu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "healthCheck", ()=>healthCheck);
parcelHelpers.export(exports, "getClienteLogado", ()=>getClienteLogado);
parcelHelpers.export(exports, "listarSolicitacoes", ()=>listarSolicitacoes);
parcelHelpers.export(exports, "criarSolicitacao", ()=>criarSolicitacao);
parcelHelpers.export(exports, "decidirSolicitacao", ()=>decidirSolicitacao);
parcelHelpers.export(exports, "listarContratos", ()=>listarContratos);
parcelHelpers.export(exports, "obterSaldoDevedor", ()=>obterSaldoDevedor);
parcelHelpers.export(exports, "criarAcordo", ()=>criarAcordo);
parcelHelpers.export(exports, "emitirBoleto", ()=>emitirBoleto);
parcelHelpers.export(exports, "baixarBoletoPdf", ()=>baixarBoletoPdf);
var _client = require("./client");
const healthCheck = ()=>(0, _client.apiGet)("/api/health");
const getClienteLogado = ()=>(0, _client.apiGet)("/api/clientes/me");
const listarSolicitacoes = ()=>(0, _client.apiGet)("/api/solicitacoes-credito");
const criarSolicitacao = ({ valorSolicitado, quantidadeParcelasSolicitada, finalidade })=>(0, _client.apiPost)("/api/solicitacoes-credito", {
...
const decidirSolicitacao = ({ id, aprovar, motivo })=>(0, _client.apiPost)(`/api/solicitacoes-credito/${id}/decisao`, {
        aprovar: Boolean(aprovar),
        motivo: motivo || null
    });
const listarContratos = ()=>(0, _client.apiGet)("/api/contratos");
const obterSaldoDevedor = (contratoId)=>(0, _client.apiGet)(`/api/contratos/${contratoId}/saldo-devedor`);
const criarAcordo = ({ contratoId, valorDesconto, quantidadeParcelas })=>(0, _client.apiPost)(`/api/contratos/${contratoId}/acordos`, {
        valorDesconto: Number(valorDesconto),
        quantidadeParcelas: Number(quantidadeParcelas)
    });
const emitirBoleto = (parcelaAcordoId)=>(0, _client.apiPostNoBody)(`/api/acordos/${parcelaAcordoId}/boleto`);
const baixarBoletoPdf = (boletoId)=>(0, _client.apiGetBlob)(`/api/boletos/${boletoId}/pdf`);

},{"./client":"1HkaN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1O6lp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "formatCurrency", ()=>formatCurrency);
parcelHelpers.export(exports, "formatDateTime", ()=>formatDateTime);
parcelHelpers.export(exports, "parseApiErrorMessage", ()=>parseApiErrorMessage);
parcelHelpers.export(exports, "renderAlert", ()=>renderAlert);
...
const parseApiErrorMessage = (error)=>{
    if (error?.payload?.mensagem) return error.payload.mensagem;
    return error?.message || "Nao foi possivel completar a operacao.";
};
const renderAlert = (wrapper, type, message)=>{
    if (!wrapper) return;
    wrapper.innerHTML = `<div class="alert alert-${type}" role="alert">${message}</div>`;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Wn5u":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "solicitacoesBanco", ()=>solicitacoesBanco);
...
const getBadgeClass = (status)=>{
    ...
    if (status === "Negada") return "bg-danger";
    return "bg-warning";
};
const renderRows = (tbody, itens, isSupervisor)=>{
    tbody.innerHTML = itens.map((item)=>{
        const actionButtons = isSupervisor && item.status === "Pendente" ? `<div class="d-flex gap-1">
				   ...
				   </div>` : '<span class="text-body-secondary fs-7">-</span>';
        return `<tr>
				<td class="text-truncate" style="max-width: 170px;" title="${item.id}">${item.id}</td>
				<td>${item.clienteId}</td>
				<td>${(0, _helpers.formatCurrency)(item.valorSolicitado)}</td>
				...
				<td>${(0, _helpers.formatDateTime)(item.criadoEm)}</td>
				<td>${actionButtons}</td>
			</tr>`;
    }).join("");
};
const refreshTable = async ({ tbody, feedback })=>{
    const { userRole } = (0, _client.getAuthContext)();
    const isSupervisor = userRole === "Supervisor";
    const itens = await (0, _endpoints.listarSolicitacoes)();
    renderRows(tbody, itens, isSupervisor);
    if (solicitacoesTable) solicitacoesTable.destroy();
    solicitacoesTable = new (0, _simpleDatatables.DataTable)("#cb-tabela-solicitacoes", {
        searchable: true,
        fixedHeight: true,
        perPage: 10
    });
    (0, _helpers.renderAlert)(feedback, "success", `${itens.length} solicitacao(oes) carregada(s).`);
};
const solicitacoesBanco = async ()=>{
    ...
    form?.addEventListener("submit", async (event)=>{
        ...
        try {
            await (0, _endpoints.criarSolicitacao)({
            ...
            form.reset();
            if (modalElement) (0, _bootstrap.Modal).getOrCreateInstance(modalElement).hide();
            await refreshTable({
                tbody,
                feedback
            });
            (0, _helpers.renderAlert)(feedback, "success", "Solicitacao criada com sucesso.");
        } catch (error) {
            (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
        }
    });
    tbody?.addEventListener("click", async (event)=>{
        ...
        try {
            await (0, _endpoints.decidirSolicitacao)({
                id,
                aprovar,
                motivo
            });
            ...
            (0, _helpers.renderAlert)(feedback, "success", `Solicitacao ${aprovar ? "aprovada" : "negada"} com sucesso.`);
        } catch (error) {
            (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
        }
    });
...
},{"bootstrap":"h36JB","simple-datatables":"1aOoN","../../api/client":"1HkaN","../../api/endpoints":"8r3Mu","./helpers":"1O6lp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h36JB":[function(require,module,exports,__globalThis) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1aOoN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DataTable", ()=>at);
parcelHelpers.export(exports, "addColumnFilter", ()=>bt);
parcelHelpers.export(exports, "convertCSV", ()=>ot);
parcelHelpers.export(exports, "convertJSON", ()=>rt);
parcelHelpers.export(exports, "createElement", ()=>s);
parcelHelpers.export(exports, "exportCSV", ()=>lt);
parcelHelpers.export(exports, "exportJSON", ()=>dt);
parcelHelpers.export(exports, "exportSQL", ()=>ct);
parcelHelpers.export(exports, "exportTXT", ()=>ht);
parcelHelpers.export(exports, "isJson", ()=>e);
parcelHelpers.export(exports, "isObject", ()=>t);
parcelHelpers.export(exports, "makeEditable", ()=>ft);
var global = arguments[3];
const t = (t)=>"[object Object]" === Object.prototype.toString.call(t), e = (e)=>{
    ...
    return s;
        ...
        "#text",
        "#comment"
    ].includes(t.nodeName) ? t.data : t.childNodes ? t.childNodes.map((t)=>i(t)).join("") : "", n = (t)=>{
    if (null == t) return "";
    ...
    return !s;
}, c = (t, e)=>t ? e ? `${t} ${e}` : t : e || "", h = function(t, e = 300) {
    let s;
    return (...i)=>{
...
var y = function(t) {
    ...
    if ([
        "#text",
        "#comment"
    ].includes(t.nodeName)) return !!n || t.data === e.data;
    ...
    if (i) return !0;
    var a = t.childNodes ? t.childNodes.slice().reverse() : [], o = e.childNodes ? e.childNodes.slice().reverse() : [];
    ...
    for(var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = V(s.length, !1), a = V(i.length, !1), o = [], r = function() {
        ...
        var t = function(t, e, s, i) {
            var n = 0, a = [], o = t.length, r = e.length, l = p([], new Array(o + 1), !0).map(function() {
                return [];
            }), d = D(t, e), c = o === r;
            ...
            for(var h = 0; h < o; h++)for(var u = t[h], f = 0; f < r; f++){
                var m = e[f];
                s[h] || i[f] || !E(u, m, d, c) ? l[h + 1][f + 1] = 0 : (l[h + 1][f + 1] = l[h][f] ? l[h][f] + 1 : 1, l[h + 1][f + 1] >= n && (n = l[h + 1][f + 1], a = [
                    h + 1,
                    f + 1
                ]));
            }
        ...
        !function(t, e, s) {
            ...
            switch(e[s._const.action]){
                ...
                case s._const.addElement:
                    ...
                    n = null === (i = k(t, d)) || void 0 === i ? void 0 : i.node, l = O(e[s._const.element]), n.childNodes || (n.childNodes = []), u >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(u, 0, l), n.subsets && n.subsets.forEach(function(t) {
...
function T(t, e) {
    ...
    if (m(t, "Text", "Comment")) s.data = t.data;
        ...
        e.valueDiffing && (m(t, "HTMLTextAreaElement") && (s.value = t.value), m(t, "HTMLInputElement") && [
            "radio",
            "checkbox"
        ].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : m(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value), m(t, "HTMLOptionElement") && (s.selected = t.selected));
    }
    return s;
}
...
var R = {
    ...
    for(var o = new RegExp(L), r = null, l = !1; !l;)if (null === (r = o.exec(t))) l = !0;
    else if (r[0].trim()) {
        if (r[1]) {
            var d = r[1].trim(), c = [
                d,
    ...
    return t.prototype.init = function() {
        ...
        do {
            ...
            0 === (s = this.findNextDiff(t, e, [])).length && (x(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, N(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), S(t, s, this.options));
        }while (s.length > 0);
        ...
        if (t.nodeName !== e.nodeName) {
            ...
            return [
                (new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(t)).setValue(this.options._const.newValue, O(e)).setValue(this.options._const.route, s)
            ];
        }
        if (s.length && this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)) return [
            (new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(t)).setValue(this.options._const.newValue, O(e)).setValue(this.options._const.route, s)
        ];
        if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data) return "#text" === t.nodeName ? [
            (new f).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)
        ] : [
            (new f).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)
        ];
        ...
        var i = t.childNodes ? t.childNodes.slice() : [], n = e.childNodes ? e.childNodes.slice() : [], a = Math.max(i.length, n.length), o = Math.abs(i.length - n.length), r = [], l = 0;
        if (!this.options.maxChildCount || a < this.options.maxChildCount) {
            var d = Boolean(t.subsets && t.subsetsAge--), c = d ? t.subsets : t.childNodes && e.childNodes ? $(t, e) : [];
            if (c.length > 0 && (r = this.attemptGroupRelocation(t, e, c, s, d)).length > 0) return r;
        }
        for(var h = 0; h < a; h += 1){
            var u = i[h], p = n[h];
            o && (u && !p ? "#text" === u.nodeName ? (r.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)), l -= 1) : (r.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, O(u))), l -= 1) : p && !u && ("#text" === p.nodeName ? r.push((new f).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data)) : r.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, O(p))))), u && p && (!this.options.maxChildCount || a < this.options.maxChildCount ? r = r.concat(this.findNextDiff(u, p, s.concat(l))) : x(u, p) || (i.length > n.length ? ("#text" === u.nodeName ? r.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, u.data)) : r.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, O(u)).setValue(this.options._const.route, s.concat(l))), i.splice(h, 1), h -= 1, l -= 1, o -= 1) : i.length < n.length ? (r = r.concat([
                (new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, O(p)).setValue(this.options._const.route, s.concat(l))
            ]), i.splice(h, 0, O(p)), o -= 1) : r = r.concat([
                (new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(u)).setValue(this.options._const.newValue, O(p)).setValue(this.options._const.route, s.concat(l))
            ]))), l += 1;
        }
        return t.innerDone = !0, r;
    }, t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
        for(var a, o, r, l, d, c = function(t, e, s) {
            var i = t.childNodes ? V(t.childNodes.length, !0) : [], n = e.childNodes ? V(e.childNodes.length, !0) : [], a = 0;
            ...
            if (!0 === h[_]) {
                ...
                } else !0 === u[v] ? b.push((new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, O(l)).setValue(this.options._const.newValue, O(m[v])).setValue(this.options._const.route, i.concat(_))) : (b.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, O(l))), h.splice(_, 1), p.splice(_, 1), g = Math.min(h.length, u.length), _ -= 1, v -= 1);
                ...
                nodeName: "#text",
                data: l.data
            }), g = Math.min(h.length, u.length)) : (b.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, O(l))), h.splice(_, 0, !0), p.splice(_, 0, O(l)), g = Math.min(h.length, u.length));
            else if (h[_] !== u[v]) {
                ...
                if (r = s[h[_]], (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue) {
                    ...
                    if (a) return [
                        (new f).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)
                    ];
                }
            }
        }
...
const q = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: h })=>({
        nodeName: "TR",
    ...
    }), B = (t, e, s, i, a, o, { classes: r, hiddenHeader: l, header: d, footer: h, format: u, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b }, { noColumnWidths: v, unhideHeader: _, renderHeader: w }, y, M)=>{
    const D = {
        nodeName: "TABLE",
        attributes: {
            ...t
                ...
                childNodes: s.map(({ row: t, index: e })=>{
                                ...
                                if (i) {
                                    if ("string" != typeof i) return i;
                                    {
                                        ...
                                        1 === t.childNodes.length && [
                                            "#text",
                                            "#comment"
                                        ].includes(t.childNodes[0].nodeName) ? r.childNodes[0].data = i : r.childNodes = t.childNodes;
                                    }
                                }
                            }
                            return r;
                    ...
                    if (e === o && (s.attributes.class = c(s.attributes.class, r.cursor)), g) {
                        ...
                        if (i) {
                            ...
                            {
                                const t = I(`<tr>${i}</tr>`);
                                !t.childNodes || 1 === t.childNodes.length && [
                                    "#text",
                                    "#comment"
                                ].includes(t.childNodes[0].nodeName) ? s.childNodes[0].data = i : s.childNodes = t.childNodes;
                            }
                        }
                    }
                    return s;
...
var U = {
    ...
    var t = 1e3, e = 6e4, s = 36e5, i = "millisecond", n = "second", a = "minute", o = "hour", r = "day", l = "week", d = "month", c = "quarter", h = "year", u = "date", p = "Invalid Date", f = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, m = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, g = {
        name: "en",
        ...
        m: function t(e, s) {
            ...
            var i = 12 * (s.year() - e.year()) + (s.month() - e.month()), n = e.clone().add(i, d), a = s - n < 0, o = e.clone().add(i + (a ? -1 : 1), d);
    ...
    var x = function() {
        ...
        return b.parse = function(t) {
            ...
            return O.u(t) ? this[e] : this.set(s, t);
        }, b.unix = function() {
            return Math.floor(this.valueOf() / 1e3);
        }, b.valueOf = function() {
            return this.$d.getTime();
        }, b.startOf = function(t, e) {
            var s = this, i = !!O.u(e) || e, c = O.p(t), p = function(t, e) {
                var n = O.w(s.$u ? Date.UTC(s.$y, e, t) : new Date(s.$y, e, t), s);
                return i ? n : n.endOf(r);
            }, f = function(t, e) {
                return O.w(s.toDate()[t].apply(s.toDate("s"), (i ? [
                    0,
                    0,
                    0,
                    0
            ...
            var s, l = O.p(t), c = "set" + (this.$u ? "UTC" : ""), p = (s = {}, s[r] = c + "Date", s[u] = c + "Date", s[d] = c + "Month", s[h] = c + "FullYear", s[o] = c + "Hours", s[a] = c + "Minutes", s[n] = c + "Seconds", s[i] = c + "Milliseconds", s)[l], f = l === r ? this.$D + (e - this.$W) : e;
            if (l === d || l === h) {
            ...
            if (f === r) return m(1);
            if (f === l) return m(7);
            var g = (u = {}, u[a] = e, u[o] = s, u[n] = t, u)[f] || 1, b = this.$d.getTime() + i * g;
            return O.w(b, this);
            ...
            var i = t || "YYYY-MM-DDTHH:mm:ssZ", n = O.z(this), a = this.$H, o = this.$m, r = this.$M, l = s.weekdays, d = s.months, c = s.meridiem, h = function(t, s, n, a) {
            ...
            var f, m = this, g = O.p(u), b = N(i), v = (b.utcOffset() - this.utcOffset()) * e, _ = this - b, w = function() {
                return O.m(m, b);
            };
            switch(g){
                case h:
    ...
    }, e = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, i = /\d\d?/, n = /\d*[^-_:/,()\s\d]+/, a = {}, o = function(t) {
            ...
            if ("string" == typeof r) {
                ...
                d && (h = o[2]), a = this.$locale(), !l && h && (a = s.Ls[h]), this.$d = function(t, e, s) {
                    try {
                        ...
                        var i = u(e)(t), n = i.year, a = i.month, o = i.day, r = i.hours, l = i.minutes, d = i.seconds, c = i.milliseconds, h = i.zone, p = new Date, f = o || (n || a ? 1 : p.getDate()), m = n || p.getFullYear(), g = 0;
...
const X = (t, e)=>{
    ...
    if (t?.constructor === Object && Object.prototype.hasOwnProperty.call(t, "data") && !Object.keys(t).find((t)=>![
            "text",
            "order",
            "data",
            "attributes"
    ...
    switch(e.type){
        ...
        case "boolean":
            "string" == typeof s.data && (s.data = s.data.toLowerCase().trim()), s.data = ![
                "false",
                !1,
                null,
                void 0,
                0
            ].includes(s.data), s.order = s.data ? 1 : 0, s.text = String(s.data);
            break;
        case "other":
            s.text = "", s.order = 0;
            break;
    ...
    if ("string" == typeof t) {
        ...
        null,
        void 0
    ].includes(t) ? e.text = "" : e.text = JSON.stringify(t);
    return e;
}, K = (t, e, s, n, a)=>{
    const o = {
        data: [],
    ...
    if (t.headings) o.headings = t.headings.map((t)=>G(t));
        ...
        const r = s[e];
        return "false" !== t.dataset.sortable?.trim().toLowerCase() && "false" !== t.dataset.sort?.trim().toLowerCase() || (r.sortable = !1), "false" === t.dataset.searchable?.trim().toLowerCase() && (r.searchable = !1), "true" !== t.dataset.hidden?.trim().toLowerCase() && "true" !== t.getAttribute("hidden")?.trim().toLowerCase() || (r.hidden = !0), [
            "number",
            "string",
            "html",
            "date",
            "boolean",
            "other"
        ].includes(t.dataset.type) && (r.type = t.dataset.type, "date" === r.type && t.dataset.format && (r.format = t.dataset.format)), o;
    });
    ...
    if (t.data) {
        ...
        o.data = t.data.map((t)=>{
            let i, n;
            return Array.isArray(t) ? (i = {}, n = t) : t.hasOwnProperty("cells") && Object.keys(t).every((t)=>[
                    "cells",
                    "attributes"
                ].includes(t)) ? (i = t.attributes, n = t.cells) : (i = {}, n = [], Object.entries(t).forEach(([t, s])=>{
                const i = e.indexOf(t);
                i > -1 && (n[i] = s);
            })), {
                attributes: i,
                        ...
                        case "boolean":
                            {
                                const e = ![
                                    ...
                                    "null",
                                    "undefined"
                                ].includes(t.innerText.toLowerCase().trim());
                                s = {
                                    data: e,
                                    text: e ? "1" : "0",
                                    order: e ? 1 : 0
...
class tt {
    ...
    remove(t) {
        if (!Array.isArray(t)) return this.remove([
            t
        ]);
...
class et {
    ...
    init() {
        [this.settings, this._state] = ((t = [], e, s)=>{
            ...
            const a = [];
            return t.forEach((t)=>{
                (Array.isArray(t.select) ? t.select : [
                    t.select
                ]).forEach((o)=>{
    ...
    sort(t, e, s = !1) {
        ...
        if (s || this.dt.emit("datatable.sorting", t, e), !e) {
            const s = !(!this._state.sort || this._state.sort.column !== t) && this._state.sort?.dir, n = i?.sortSequence || [
                "asc",
                "desc"
            ];
            if (s) {
        ...
        const a = !![
            "string",
            "html"
        ].includes(i.type) && new Intl.Collator(i.locale || this.dt.options.locale, {
            usage: "sort",
...
class at {
    ...
    constructor(t, e = {}){
        ...
        }, this._dd = new F(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init();
    }
    init() {
            ...
            childNodes: [
                {
                    nodeName: "THEAD",
                    childNodes: [
                        q(this.data.headings, this.columns.settings, this.columns._state, this.options, {
                            unhideHeader: !0
                        })
                    ]
                }
    ...
    _bindEvents() {
        ...
        this.options.searchable && this.wrapperDOM.addEventListener("input", (t)=>{
            ...
            if (Array.from(this.wrapperDOM.querySelectorAll(e)).filter((t)=>t.value.length).forEach((t)=>{
                const e = t.dataset.and || this.options.searchAnd, s = t.dataset.querySeparator || this.options.searchQuerySeparator ? t.value.split(this.options.searchQuerySeparator) : [
                    t.value
                ];
                e ? s.forEach((e)=>{
            ...
            if (e) {
                if (e.hasAttribute("data-page")) this.page(parseInt(e.getAttribute("data-page"), 10)), t.preventDefault();
                    ...
                    const s = Array.from(e.parentElement.parentElement.children).indexOf(e.parentElement), i = o(s, this.columns.settings);
    ...
    _paginate() {
        ...
        }), this.options.paging && this.options.perPage > 0 ? this.pages = t.map((e, s)=>s % this.options.perPage == 0 ? t.slice(s, s + this.options.perPage) : null).filter((t)=>t) : this.pages = [
            t
        ], this.totalPages = this.lastPage = this.pages.length, this._currentPage || (this._currentPage = 1), this.totalPages;
    }
    _fixHeight() {
    ...
    multiSearch(t, e = "search") {
        ...
        const i = s.map((t)=>this.columns.settings.map((e, s)=>{
                ...
                [
                    "base",
                    "accent"
                ].includes(n) && (i = i.map((t)=>t.toLowerCase())), [
                    "base",
                    "case"
                ].includes(n) && (i = i.map((t)=>t.normalize("NFD").replace(/\p{Diacritic}/gu, "")));
            ...
            const a = t.cells.map((t, e)=>{
                ...
                if (i.length) {
                    ...
                    [
                        "base",
                        "accent"
                    ].includes(t) && (i = i.toLowerCase()), [
                        "base",
                        "case"
                    ].includes(t) && (i = i.normalize("NFD").replace(/\p{Diacritic}/gu, ""));
...
const ot = function(e) {
    ...
    const i = {
        ...
        columnDelimiter: ",",
        ...s
    }, a = (t)=>!i.skipColumn.includes(t) && !e.columns.settings[t]?.hidden, o = e.data.headings.filter((t, e)=>a(e)).map((t)=>t.text ?? t.data);
    let r;
    if (i.selection) {
    ...
    const r = o.map((t)=>t.cells.filter((t, e)=>a(e)).map((t)=>n(t))), l = e.data.headings.filter((t, e)=>a(e)).map((t)=>t.text ?? String(t.data));
    if (r.length) {
        const t = [];
        r.forEach((e, s)=>{
    ...
    let o = [];
    if (i.selection) {
        if (Array.isArray(i.selection)) for(let t = 0; t < i.selection.length; t++)o = o.concat(e.pages[i.selection[t] - 1].map((t)=>t.row));
        else o = e.pages[i.selection - 1].map((t)=>t.row);
    } else o = e.data.data;
    const r = o.map((t)=>t.cells.filter((t, e)=>a(e)).map((t)=>n(t))), l = e.data.headings.filter((t, e)=>a(e)).map((t)=>t.text ?? String(t.data));
    if (r.length) {
...
class pt {
    ...
    click(t) {
        ...
        if (e instanceof Element) {
            if (this.editing && this.data && this.editingCell) {
                const t = l(this.options.classes.input), e = this.modalDOM ? this.modalDOM.querySelector(`input${t}[type=text]`) : this.dt.wrapperDOM.querySelector(`input${t}[type=text]`);
    ...
    editCellModal() {
        const t = this.data.cell, e = this.data.columnIndex, i = this.dt.data.headings[e].text || String(this.dt.data.headings[e].data), o = [
    ...
    saveCell(t) {
        const e = this.data.content, s = this.dt.columns.settings[this.data.columnIndex].type || this.dt.options.type, i = t.trim();
        let n;
        if ("number" === s) n = {
            data: parseFloat(i)
        };
    ...
    editRowModal() {
        ...
        const d = l(this.options.classes.input), c = Array.from(r.querySelectorAll(`input${d}[type=text]`));
    ...
    rowRender(t, e, s) {
        ...
        if (this.editingCell) e.childNodes[function(t, e) {
            let s = t, i = 0;
            ...
            if (!this.options.excludeColumns.includes(n)) e.childNodes[i].childNodes = [
                {
                    nodeName: "INPUT",
                    attributes: {
                        type: "text",
    ...
    _click(t) {
        ...
        if (e instanceof Element) {
            if (this.event = t, this.buttonDOM.contains(e)) {
                ...
                i.checked ? this.dt.columns.show([
                    n
                ]) : this.dt.columns.hide([
                    n
                ]);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4sSri":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "contratosBanco", ()=>contratosBanco);
var _simpleDatatables = require("simple-datatables");
var _endpoints = require("../../api/endpoints");
var _helpers = require("./helpers");
let contratosTable;
const statusBadge = (status)=>{
    if ((status || "").toLowerCase() === "ativo") return "bg-success";
    return "bg-secondary";
};
const contratosBanco = async ()=>{
    const table = document.getElementById("cb-tabela-contratos");
    if (!table) return;
    const tbody = table.querySelector("tbody");
    const feedback = document.getElementById("cb-contratos-feedback");
    try {
        const contratos = await (0, _endpoints.listarContratos)();
        tbody.innerHTML = contratos.map((item)=>`<tr>
					<td class="text-truncate" style="max-width: 170px;" title="${item.id}">${item.id}</td>
					<td>${item.clienteId}</td>
					<td>${item.numeroContrato}</td>
					<td>${(0, _helpers.formatCurrency)(item.valorPrincipal)}</td>
        ...
        if (contratosTable) contratosTable.destroy();
        contratosTable = new (0, _simpleDatatables.DataTable)("#cb-tabela-contratos", {
            searchable: true,
            fixedHeight: true,
            perPage: 10
        });
        (0, _helpers.renderAlert)(feedback, "success", `${contratos.length} contrato(s) carregado(s).`);
    } catch (error) {
        (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
    }
};

},{"simple-datatables":"1aOoN","../../api/endpoints":"8r3Mu","./helpers":"1O6lp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1NQnr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saldoDevedorBanco", ()=>saldoDevedorBanco);
var _endpoints = require("../../api/endpoints");
var _helpers = require("./helpers");
...
const saldoDevedorBanco = async ()=>{
    const feedback = document.getElementById("cb-saldo-feedback");
    if (!feedback) return;
    const params = new URLSearchParams(window.location.search);
    const contratoId = params.get("contratoId");
    if (!contratoId) {
        (0, _helpers.renderAlert)(feedback, "warning", "Informe o contrato pela query string: ?contratoId=<guid>.");
        return;
    }
    try {
        const saldo = await (0, _endpoints.obterSaldoDevedor)(contratoId);
        setText("cb-saldo-contrato", saldo.numeroContrato);
        setText("cb-saldo-principal", (0, _helpers.formatCurrency)(saldo.principal));
        setText("cb-saldo-juros-multa", (0, _helpers.formatCurrency)(Number(saldo.juros || 0) + Number(saldo.multa || 0)));
        setText("cb-saldo-total", (0, _helpers.formatCurrency)(saldo.total));
        setText("cb-saldo-calculado-em", (0, _helpers.formatDateTime)(saldo.calculadoEm));
        (0, _helpers.renderAlert)(feedback, "success", "Saldo devedor carregado com sucesso.");
    } catch (error) {
        (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
    }
};

},{"../../api/endpoints":"8r3Mu","./helpers":"1O6lp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7gJdN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "acordosBanco", ()=>acordosBanco);
var _endpoints = require("../../api/endpoints");
var _helpers = require("./helpers");
const fillFromQuery = ()=>{
    const contratoInput = document.getElementById("cb-acordo-contrato-id");
    if (!contratoInput || contratoInput.value) return;
    const params = new URLSearchParams(window.location.search);
    const contratoId = params.get("contratoId");
    if (contratoId) contratoInput.value = contratoId;
};
const acordosBanco = ()=>{
    ...
    formAcordo?.addEventListener("submit", async (event)=>{
        event.preventDefault();
        try {
            const result = await (0, _endpoints.criarAcordo)({
            ...
            (0, _helpers.renderAlert)(feedback, "success", `Acordo criado com sucesso. ID: ${result.id}`);
        } catch (error) {
            (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
        }
    });
    formBoleto?.addEventListener("submit", async (event)=>{
        ...
        try {
            ...
            const result = await (0, _endpoints.emitirBoleto)(parcelaAcordoId);
            (0, _helpers.renderAlert)(feedback, "success", `Boleto emitido com sucesso. ID: ${result.id}`);
        } catch (error) {
            (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
        }
    });
    formDownload?.addEventListener("submit", async (event)=>{
        ...
        try {
            ...
            const blob = await (0, _endpoints.baixarBoletoPdf)(boletoId);
            ...
            (0, _helpers.renderAlert)(feedback, "success", "Download do boleto iniciado.");
        } catch (error) {
            (0, _helpers.renderAlert)(feedback, "danger", (0, _helpers.parseApiErrorMessage)(error));
        }
    });
...
},{"../../api/endpoints":"8r3Mu","./helpers":"1O6lp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8G2QE","ebWYT"], "ebWYT", "parcelRequire94c2")

//# sourceMappingURL=acordos.739bf03c.js.map
